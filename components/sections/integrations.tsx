      ...
      <div className="flex flex-col items-center pt-16">
        ...
        <div className="border-divide divide-divide mt-16 hidden w-full grid-cols-2 divide-x border-t lg:grid">
          ...
          <div className="divide-divide divide-y">
            <button className="group relative flex w-full flex-col items-start overflow-hidden px-12 py-8 hover:bg-gray-100 dark:hover:bg-neutral-800">
              <div className="absolute inset-x-0 z-20 h-full w-full bg-white mask-t-from-50% dark:bg-neutral-900"></div>
              <canvas className="w-full h-full absolute inset-0 scale-[1.01] opacity-20" style={{imageRendering: "pixelated"}}></canvas>
              <div className="bg-brand absolute inset-x-0 bottom-0 z-30 h-0.5 w-full rounded-full" style={{width: "21.9764%"}}></div>
            ...
            <button className="group relative flex w-full flex-col items-start overflow-hidden px-12 py-8 hover:bg-gray-100 dark:hover:bg-neutral-800">
              <div className="text-charcoal-700 relative z-20 flex items-center gap-2 font-medium dark:text-neutral-100 group-hover:text-brand">
                <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
            ...
            <div className="absolute inset-0" style={{filter: "blur(0px)", opacity: 1}}>
              <div className="mt-12 flex flex-col items-center">
                <div className="relative">
                  ...
                  {/* Complex SVG animations would go here - simplified for brevity */}
