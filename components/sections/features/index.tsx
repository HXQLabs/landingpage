          ...
          {signupSteps.map((step, index) => (
            ...
            >
              ...
              <div className="h-7 sm:h-10 md:h-12 bg-gray-100 dark:bg-neutral-800 flex items-center justify-center relative">
                <div
                  className={`w-4 sm:w-6 md:w-7 h-4 sm:h-6 md:h-7 rounded-full flex items-center justify-center text-xs sm:text-sm ${
                    index <= currentStep
                ...
                >
                  {index < currentStep ? (
                    ...
                    <svg
                      className={`w-3 sm:w-4 h-3 sm:h-4 ${index === currentStep ? "text-blue-600 dark:text-blue-400" : "text-gray-400"}`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span
                      className={`${index === currentStep ? "text-blue-600 dark:text-blue-400" : "text-gray-400"} text-xs`}
                    >
                      {step.icon}
                    </span>
                  )}
              ...
              <div className="px-1 sm:px-2 py-1 sm:py-1.5 text-center bg-gray-100 dark:bg-neutral-800 flex-1 flex flex-col justify-center">
                ...
                {/* Step Number */}
                <div
                  className={`text-[6px] sm:text-[8px] md:text-[9px] font-bold ${
                    index <= currentStep
    ...
    <section className="container mx-auto flex w-full max-w-5xl flex-col items-center justify-start px-2 sm:px-4 py-16 text-center md:py-32 overflow-hidden">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-muted-foreground text-base tracking-tight mt-4 max-w-2xl">
          Skip cold outreach. Set your skills and preferences, get matched in
          seconds, and have meaningful conversations mock interviews, mentoring,
          code reviews, or pitch practice.
        </p>
      </div>
      ...
      <div className="mt-10 flex w-full flex-col gap-4 md:mt-14">
        <CursorCardsContainer className="flex flex-col md:flex-row gap-3 sm:gap-6 md:h-[380px]">
          ...
          <CursorCard
            ...
            className="h-full md:w-[45%] w-full rounded-xl p-2 sm:p-4 md:p-7 shadow-md bg-white dark:bg-neutral-950 border-gray-200 dark:border-neutral-800 overflow-hidden"
          >
            <div className="h-full flex flex-col">
              <div className="mb-4 text-left">
                ...
                <p className="text-muted-foreground text-sm">
                  Connect with professionals worldwide based on your{" "}
                  <strong>skills</strong>, <strong>industry</strong>, and{" "}
                  <strong>language</strong> for meaningful global collaboration.
                </p>
              </div>
              <div className="flex-1 relative overflow-hidden rounded-lg min-h-[200px]">
          ...
          <CursorCard
            borderColor={theme === "dark" ? "#262626" : "#e5e5e5"}
            className="h-full md:w-[55%] w-full rounded-xl p-4 sm:p-7 shadow-md bg-white dark:bg-neutral-950 border-gray-200 dark:border-neutral-800 overflow-hidden"
          >
            <div className="h-full flex flex-col">
              <div className="mb-4 text-left">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                ...
                <p className="text-muted-foreground text-sm">
                  Securely connect with LinkedIn, stay anonymous to matches. No
                  lengthy forms, no spam - just real professional networking.
                </p>
              </div>
        ...
        <CursorCardsContainer className="flex flex-col md:flex-row gap-3 sm:gap-6 md:h-[380px]">
          ...
          >
            <div className="h-full flex flex-col">
              <div className="mb-4 text-left">
                ...
                <p className="text-muted-foreground text-sm">
                  Mock interviews (behavioral & technical), pair programming,
                  portfolio critique, and startup pitch practice with feedback
                  etc.
                </p>
              </div>
              <div className="flex-1 relative overflow-hidden rounded-lg min-h-[200px]">
          ...
          <CursorCard
            borderColor={theme === "dark" ? "#262626" : "#e5e5e5"}
            className="h-full md:w-[45%] w-full rounded-xl p-4 md:p-7 shadow-md bg-white dark:bg-neutral-950 border-gray-200 dark:border-neutral-800 overflow-hidden"
          >
            <div className="h-full flex flex-col">
              <div className="mb-3 md:mb-4 text-left">
                ...
                <p className="text-muted-foreground text-xs md:text-sm">
                  Real time chats for meaningful conversations.
                </p>
              </div>
                ...
                <div className="flex-1 p-3 md:p-4 space-y-4 md:space-y-6 overflow-y-auto min-h-0">
                  ...
                  >
                    <div className="flex items-center gap-1.5 md:gap-2 mb-1.5 md:mb-2">
                      <span className="text-gray-900 dark:text-white text-[10px] md:text-xs font-medium">
                        Peer
                      </span>
