...
const FeatureGrid = ({ isYearly }: { isYearly: boolean }) => {
  return (
    <div className="max-w-7xl mx-auto border-l border-r border-gray-200 dark:border-neutral-700 hidden md:block">
...
export default function PricingNewSection() {
  ...
  return (
    <section className="">
      {/* Header */}
      <div className="max-w-7xl mx-auto border-l border-r border-gray-200 dark:border-neutral-700 flex flex-col items-center justify-center pt-10 pb-10">
        <AnimatedShinyText>
          Pricing
        </AnimatedShinyText>
      ...
      {/* Pricing Cards */}
      <div className="max-w-7xl mx-auto border-l border-r border-gray-200 dark:border-neutral-700">
        <div className="grid grid-cols-1 divide-y md:grid-cols-3 md:divide-x md:divide-y-0 divide-gray-200 dark:divide-neutral-700">
          {TIERS.map((tier) => (
      ...
      {/* Divider */}
      <div className="bg-gray-200 dark:bg-neutral-700 h-[1px]" />
      
      {/* Feature Grid - Desktop Only */}
      <FeatureGrid isYearly={isYearly} />
      {/* <div className="bg-gray-200 dark:bg-neutral-700 h-[1px] w-full" /> */}
    </section>
  );
}
